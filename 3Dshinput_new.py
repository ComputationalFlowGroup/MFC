...
# ==========================================================
    ...
    'patch_icpp(1)%alpha_rho(1)'   : (alpha1-alph_eps)*rholn,
    'patch_icpp(1)%alpha_rho(2)'   : alph_eps*rhogn,
    'patch_icpp(1)%alpha(1)'       : alpha1-alph_eps,
    'patch_icpp(1)%alpha(2)'       : alph_eps,
    # ==========================================================
    # Patch 2: Bubble  ======================================
    ...
    'patch_icpp(2)%alpha_rho(1)'   : alph_eps*rholn,
    'patch_icpp(2)%alpha_rho(2)'   : (alpha2-alph_eps)*rhogn,
    'patch_icpp(2)%alpha(1)'       : alph_eps,
    'patch_icpp(2)%alpha(2)'       : alpha2-alph_eps,
    # ==========================================================
