...
print(json.dumps({
                    ...
                    'patch_icpp(1)%alpha_rho(1)'   : 9961*(1.0-(1.E-6)),
                    'patch_icpp(1)%alpha(1)'       : (1.0-(1.E-6)),
                    'patch_icpp(1)%alpha_rho(2)'   : 2260*(1.E-6),
                    ...
                    'patch_icpp(2)%alpha_rho(1)'   : 9961*(1.E-6),
                    'patch_icpp(2)%alpha(1)'       : 1.E-6,
                    'patch_icpp(2)%alpha_rho(2)'   : 2260*(1.0-(1.E-6)),
                    ...
                    'patch_icpp(3)%alpha_rho(1)'   : 11042*(1.0-(1.E-6)),
                    'patch_icpp(3)%alpha(1)'       : 1.0-(1.E-6),
                    'patch_icpp(3)%alpha_rho(2)'   : 2260*(1.E-6),
                    'patch_icpp(3)%alpha(2)'       : 1.E-6,
                    # ==========================================================
