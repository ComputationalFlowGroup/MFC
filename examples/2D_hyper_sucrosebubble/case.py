    ...
    json.dumps(
        {
            ...
            "patch_icpp(1)%alpha_rho(1)": 1.0e0,
            ...
            "fluid_pp(1)%gamma": 1 / 1.09e0,  # 1.E+00/(1.4E+00-1.E+00),
            "fluid_pp(1)%pi_inf": Kt0_suc / (rho_0_suc * c_0 * c_0),  # isothermal bulk modulus
            "fluid_pp(2)%gamma": 1 / 0.4e0,  # 1.E+00/(1.6666E+00-1.E+00),
