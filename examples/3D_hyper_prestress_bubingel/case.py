...
print(json.dumps({
    ...
    ## ==========================================================
    # Patch 2: For prestress and xi_RMT initialization===========
    ...
    'patch_icpp(3)%x_centroid'     : xcenb,
    'patch_icpp(3)%y_centroid'     : ycenb,
    'patch_icpp(3)%z_centroid'     : zcenb,
    'patch_icpp(3)%radius'         : R0,
    'patch_icpp(3)%vel(1)'         : 0.0E+00,
    'patch_icpp(3)%vel(2)'         : 0.0E+00,
    'patch_icpp(3)%vel(3)'         : 0.0E+00,
    'patch_icpp(3)%pres'           : p02,    	
    'patch_icpp(3)%alpha_rho(4)'   : bub_wl*rho0wl2,           	
    'patch_icpp(3)%alpha_rho(2)'   : bub_wv*rho0wv2,           	
    'patch_icpp(3)%alpha_rho(3)'   : bub_wa*rho0wa2,           
    'patch_icpp(3)%alpha_rho(1)'   : bub_wg*rho0wg2,
    'patch_icpp(3)%alpha(4)'       : bub_wl,   	
    'patch_icpp(3)%alpha(2)'       : bub_wv,   	
    'patch_icpp(3)%alpha(3)'       : bub_wa,
    'patch_icpp(3)%alpha(1)'       : bub_wg,
    # ==========================================================
    # Patch 3: Gel Object ======================================
    'patch_icpp(4)%geometry'       : 9,
    'patch_icpp(4)%alter_patch(2)' : 'T',
    'patch_icpp(4)%x_centroid'     : 20*xceng,
    'patch_icpp(4)%y_centroid'     : 20*yceng,
    'patch_icpp(4)%z_centroid'     : 20*zceng,
    'patch_icpp(4)%length_x'       : 20*xe,
