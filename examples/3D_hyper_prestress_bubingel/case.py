...
#    'patch_icpp(1)%hcid'           : 302, 	
    ...
    #'patch_icpp(2)%x_centroid'     : 20*xcenl,
    #'patch_icpp(2)%y_centroid'     : 20*ycenl,
    #'patch_icpp(2)%z_centroid'     : 20*zcenl,
    #patch_icpp(2)%length_x'       : 20*lenx,
    #'patch_icpp(2)%length_y'       : 20*leny,
    #'patch_icpp(2)%length_z'       : 20*lenz,
    #'patch_icpp(2)%vel(1)'         : 0.0E+00,
    #'patch_icpp(2)%vel(2)'         : 0.0E+00,
    #'patch_icpp(2)%vel(3)'         : 0.0E+00,
    #'patch_icpp(2)%pres'           : p01,    	
    #'patch_icpp(2)%alpha_rho(4)'   : liq_wl * rho0wl1,           	
    #'patch_icpp(2)%alpha_rho(2)'   : liq_wv * rho0wv1,            
    #'patch_icpp(2)%alpha_rho(3)'   : liq_wa * rho0wa1,
    #'patch_icpp(2)%alpha_rho(1)'   : liq_wg * rho0wg1,            
    #'patch_icpp(2)%alpha(4)'       : liq_wl,   	
    #'patch_icpp(2)%alpha(2)'       : liq_wv,   	
    #'patch_icpp(2)%alpha(3)'       : liq_wa,
    #'patch_icpp(2)%alpha(1)'       : liq_wg,   	
    #'patch_icpp(2)%alpha_rho(4)'   : gel_wl * rho0wl3,           	
    #'patch_icpp(2)%alpha_rho(2)'   : gel_wv * rho0wv3,           	
    #'patch_icpp(2)%alpha_rho(3)'   : gel_wa * rho0wa3,
    #'patch_icpp(2)%alpha_rho(1)'   : gel_wg * rho0wg3,           	
    #'patch_icpp(2)%alpha(4)'       : gel_wl,   	
    #'patch_icpp(2)%alpha(2)'       : gel_wv,   	
    #'patch_icpp(2)%alpha(3)'       : gel_wa,
    #'patch_icpp(2)%alpha(1)'       : gel_wg,	
    ##==========================================================
   ...
   # 'patch_icpp(3)%hcid'           : 302,
    ...
    'patch_icpp(3)%alpha_rho(1)'   : gel_wg * rho0wg3,           	
    'patch_icpp(3)%alpha(4)'       : gel_wl,   	
    ...
    'patch_icpp(4)%pres'           : p01,    	
    'patch_icpp(4)%alpha_rho(4)'   : liq_wl * rho0wl1,           	
    'patch_icpp(4)%alpha_rho(2)'   : liq_wv * rho0wv1,            
    'patch_icpp(4)%alpha_rho(3)'   : liq_wa * rho0wa1,
    'patch_icpp(4)%alpha_rho(1)'   : liq_wg * rho0wg1,            
    'patch_icpp(4)%alpha(4)'       : liq_wl,   	
    'patch_icpp(4)%alpha(2)'       : liq_wv,   	
    'patch_icpp(4)%alpha(3)'       : liq_wa,
    'patch_icpp(4)%alpha(1)'       : liq_wg,   	
    ...
    'fluid_pp(3)%G'                : Ga,
    'fluid_pp(1)%gamma'            : 1.0E+00 / ( gamwg - 1),
    'fluid_pp(1)%pi_inf'           : gamwg * pig / ( gamwg - 1),
    'fluid_pp(1)%cv'               : cvg,
    'fluid_pp(1)%qv'               : qvwg,
