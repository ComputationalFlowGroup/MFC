...
print(json.dumps({
   ...
   # Patch 2: Bubble ==========================================================
    ...
    # Patch 3: Shocked state ===================================================
    'patch_icpp(3)%geometry'       : 3,
    'patch_icpp(3)%alter_patch(1)' : 'T',
    'patch_icpp(3)%x_centroid'     : -3*leng/8.,
    'patch_icpp(3)%y_centroid'     : 0.,
    'patch_icpp(3)%length_x'       : leng/4.,
    'patch_icpp(3)%length_y'       : leng,
    'patch_icpp(3)%vel(1)'         : vel,
    'patch_icpp(3)%vel(2)'         : 0.E+00,
    'patch_icpp(3)%pres'           : ps,
    'patch_icpp(3)%alpha_rho(1)'   : 2.4, #NO IDEA
    'patch_icpp(3)%alpha_rho(2)'   : 0.E+00,
    'patch_icpp(3)%alpha(1)'       : 1.E+00,
    'patch_icpp(3)%alpha(2)'       : 0.E+00,
    # ==========================================================================
    ...
    'fluid_pp(3)%gamma'            : 1.E+00/(1.6666E+00-1.E+00),
    'fluid_pp(3)%pi_inf'           : 0.E+00,
