...
END
    ...
    printf "$TABLE_HEADER"
    printf "$TABLE_TITLE_FORMAT" "MFC case # test1 @ /oscar/home/mcarcana/MFC/examples/2D_sucrosebubble_shock/case.py:"
    printf "$TABLE_HEADER"
...
echo
    ...
    cd "/oscar/home/mcarcana/MFC/examples/2D_sucrosebubble_shock"

    t_syscheck_start=$(perl -MTime::HiRes=time -e 'printf "%.9f\n", time')


        (set -x;                 mpirun -np 4                                                        "/oscar/home/mcarcana/MFC/build/install/7e71bfa6d4/bin/syscheck")
    ...
    t_post_process_start=$(perl -MTime::HiRes=time -e 'printf "%.9f\n", time')
        ...
        (set -x;                 mpirun -np 4                                                        "/oscar/home/mcarcana/MFC/build/install/88890036a0/bin/post_process")
