...
# sod = xdist/R0
sod = lenx
xcenb = 0.00  # neg for bub in liq; pos bub in gel
ycenb = 0.00
zcenb = 0.00
    ...
    json.dumps(
        {
            ...
            # Patch 3: Gel Object
            "patch_icpp(1)%geometry": 9,
            "patch_icpp(1)%x_centroid": 20 * xceng,
            "patch_icpp(1)%y_centroid": 20 * yceng,
            "patch_icpp(1)%z_centroid": 20 * zceng,
            "patch_icpp(1)%length_x": 20 * xe,
            "patch_icpp(1)%length_y": 20 * leny,
            "patch_icpp(1)%length_z": 20 * lenz,
            "patch_icpp(1)%vel(1)": 0.0e00,
            "patch_icpp(1)%vel(2)": 0.0e00,
            ...
            "fluid_pp(3)%G": Ga,
            "fluid_pp(1)%gamma": 1.0e00 / (gamwg - 1),
