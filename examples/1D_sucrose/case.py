...
#Initial condition
theta_0           = 298             #K
P_0               = 1e6             #Pa (Gauge pressure is zero)
...
print(json.dumps({
    ...
    'x_domain%beg'                 :  -leng/2.,
    'x_domain%end'                 :  leng/2,
    'y_domain%beg'                 :  -0.01*leng/2.,
    'y_domain%end'                 :  +0.01*leng/2.,
    'm'                            : int(Nx),
    'n'                            : int(Ny),
    'p'                            : 0,
    'dt'                           : dt,
    ...
    'patch_icpp(1)%length_x'       : 5*leng,
    'patch_icpp(1)%length_y'       : 0.1*leng,
    ...
    #'patch_icpp(2)%length_x'       : leng/2.5,
    'patch_icpp(2)%alter_patch(1)' : 'T',
