...
PATTERNS = [
    ...
    (r"fluid_pp\((\d+)\)%G_graded", "Graded shear modulus for fluid {0}"),
    (r"fluid_pp\((\d+)\)%G_init", "Initial shear modulus for graded fluid {0}"),
    (r"fluid_pp\((\d+)\)%G_end", "End shear modulus for graded fluid {0}"),
    (r"fluid_pp\((\d+)\)%mu_graded", "Graded viscosity for fluid {0}"),
    (r"fluid_pp\((\d+)\)%mu_init", "Initial viscosity for graded fluid {0}"),
    (r"fluid_pp\((\d+)\)%mu_end", "End viscosity for graded fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_profile", "Grading profile for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_beg(1)", "X-coordinate for start of grading for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_beg(2)", "Y-coordinate for start of grading for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_beg(3)", "Z-coordinate for start of grading for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_end(1)", "X-coordinate for end of grading for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_end(2)", "Y-coordinate for end of grading for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_end(3)", "Z-coordinate for end of grading for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_center(1)", "X-coordinate for center of radially grading for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_center(2)", "Y-coordinate for center of radially grading for fluid {0}"),
