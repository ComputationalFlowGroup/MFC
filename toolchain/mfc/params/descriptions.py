...
PATTERNS = [
    ...
    (r"fluid_pp\((\d+)\)%Ca", "Inverse of Cauchy number for fluid {0}"),
    ...
    (r"fluid_pp\((\d+)\)%graded_Ca", "Graded elasticity for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_Ca_init", "Initial value of Cauchy number for graded fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_Ca_end", "End value of Cauchy number for graded fluid {0}"),
