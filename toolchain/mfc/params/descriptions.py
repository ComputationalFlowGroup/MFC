...
PATTERNS = [
    ...
    (r"fluid_pp\((\d+)\)%Ca_inv", "Inverse of Cauchy number for fluid {0}"),
    ...
    (r"fluid_pp\((\d+)\)%graded_Ca_inv", "Graded elasticity for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_Ca_inv_init", "Initial value of Cauchy number for graded fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_Ca_inv_end", "End value of Cauchy number for graded fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_Re", "Graded Reynolds number for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_Re_init\((\d+)\)", "Initial Reynold's number component {1} for graded fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_Re_end\((\d+)\)", "End Reynold's number component {1} for graded fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_K_bulk", "Graded bulk modulus for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_K_bulk_init", "Initial bulk modulus for graded fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_K_bulk_end", "End bulk modulus for graded fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_profile", "Grading profile for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_type", "Grading type for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_beg_loc\((\d+)\)", "{1}-coordinate for start of grading for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_end_loc\((\d+)\)", "{1}-coordinate for end of grading for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_center_loc\((\d+)\)", "{1}-coordinate for center of radially grading for fluid {0}"),
    ...
    (r"fluid_pp\((\d+)\)%graded_pf_coeff", "'k' constant in power law function for graded fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_exp", "Power law exponent for graded fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_scaling", "Power law scaling factor for graded fluid {0}"),
    # patch_ib patterns
