...
PATTERNS = [
    ...
    (r"fluid_pp\((\d+)\)%graded_Re", "Graded viscosity for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_Re_init", "Initial viscosity for graded fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_Re_end", "End viscosity for graded fluid {0}"),
