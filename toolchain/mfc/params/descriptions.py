...
PATTERNS = [
    ...
    (r"fluid_pp\((\d+)\)%graded_G", "Graded shear modulus for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_G_init", "Initial shear modulus for graded fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_G_end", "End shear modulus for graded fluid {0}"),
    ...
    (r"fluid_pp\((\d+)\)%graded_beg\((\d+)\)", "{1}-coordinate for start of grading for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_end\((\d+)\)", "{1}-coordinate for end of grading for fluid {0}"),
    (r"fluid_pp\((\d+)\)%graded_center\((\d+)\)", "{1}-coordinate for center of radially grading for fluid {0}"),
