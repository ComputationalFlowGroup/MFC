...
contains
   !>   The following subroutine handles the hypoelastic evolution
    ...
    subroutine s_compute_hypoplastic_rhs(q_prim_vf, q_cons_vf, rhs_vf)
        ...
        real(kind(0d0)), dimension(2*num_dims) :: stensor, tensora, devdtensor, Dp
...
!                 print *, 'I got here G' 
                ...
                devdtensor(2) = 0.5d0*dv_dx(k, l, q)
                
                tensora(1) = -stensor(1)*dv_dx(k, l, q)
                tensora(2) = +0.5d0*stensor(2)*dv_dx(k, l, q)
        ...
        do l = 0, n
          do k = 0, m
             ...
             stensor(1) = 2d0*q_prim_vf(strxb+1)%sf(k, l, q) !2*S12
...
!             print *, 'I got here a'           
             ...
             devdtensor(4) = -(1d0/3d0)*(du_dx(k, l, q) + dv_dy(k, l, q))
!             print *, 'I got here A' 
!             print *, 'k ::', k, 'l ::', l, 'q ::', q, &
