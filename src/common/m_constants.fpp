...
module m_constants
    ...
    integer, parameter :: Ifactor_bary_3D = 1 !< Multiple factor of the ratio (triangle area to cell face area) for interpolation on triangle facets for 3D models
    integer, parameter :: num_ray = 1 !< Default number of rays traced per cell
    ...
    real(wp), parameter :: threshold_bary = 1.e5_wp !< Threshold to interpolate a barycentric facet
