#:def s_compute_speed_of_sound()
    subroutine s_compute_speed_of_sound(pres, rho, gamma, pi_inf, H, adv, vel_sum, c, G, alpha_K, alpha_rho_K)
#ifdef CRAY_ACC_WAR
        ...
        real(kind(0d0)), optional, dimension(num_fluids), intent(IN) :: G, alpha_K, alpha_rho_K
