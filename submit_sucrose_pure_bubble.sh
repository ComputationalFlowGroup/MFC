...
#./mfc.sh run ./examples/3D_bubble_channel/case.py -p gpuA100x4 -N 1 -n 4 -g 1 -w 01:00:00 -# test1 -t pre_process -a bciv-delta-gpu -c delta
...
./mfc.sh run ./examples/2D_sucrose_pure_bubble/case.py -p batch -N 4 -n 1 -g 4 -w 01:00:00 -# test1 -t pre_process -c oscar
./mfc.sh run ./examples/2D_sucrose_pure_bubble/case.py -p batch -N 4 -n 1 -g 4 -w 01:00:00 -# test1 -t simulation -c oscar
./mfc.sh run ./examples/2D_sucrose_pure_bubble/case.py -p batch -N 4 -n 1 -g 4 -w 01:00:00 -# test1 -t post_process -c oscar
