...
./mfc.sh run ./examples/3D_hyper_prestress_bubingel/2dcase.py -p batch -N 1 -n 1 -g 0 -w 01:00:00 -# test1 -t pre_process -c oscar
./mfc.sh run ./examples/3D_hyper_prestress_bubingel/2dcase.py -p batch -N 1 -n 1 -g 0 -w 01:00:00 -# test1 -t simulation -c oscar
./mfc.sh run ./examples/3D_hyper_prestress_bubingel/2dcase.py -p batch -N 1 -n 1 -g 0 -w 01:00:00 -# test1 -t post_process -c oscar
