...
$(printf "$TABLE_FORMAT_LINE" "Job Name"     "oweak2"                        "Engine"     "interactive")
...
END
    ...
    printf "$TABLE_HEADER"
    printf "$TABLE_TITLE_FORMAT" "MFC case # oweak2 @ /u/mcarcanabarbosa/MFC/hypertest/1D_hypo_impact_weak/case.py:"
    printf "$TABLE_HEADER"
...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/sw/spack/deltas11-2023-03/apps/linux-rhel8-zen3/nvhpc-22.11/openmpi-4.1.5-nzb4n4r/lib/
    ...
    cd "/u/mcarcanabarbosa/MFC/hypertest/1D_hypo_impact_weak"
    ...
    printf "$TABLE_HEADER"
    printf "$TABLE_TITLE_FORMAT" "Finished oweak2:"
