...
$(printf "$TABLE_FORMAT_LINE" "Job Name"     "erweak3"                        "Engine"     "interactive")
...
END
    ...
    printf "$TABLE_HEADER"
    printf "$TABLE_TITLE_FORMAT" "MFC case # erweak3 @ /u/mcarcanabarbosa/MFC/examples/1D_hyper_impact/case.py:"
    printf "$TABLE_HEADER"
...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/sw/spack/deltas11-2023-03/apps/linux-rhel8-zen3/nvhpc-22.11/openmpi-4.1.5-nzb4n4r/lib/
    ...
    printf "$TABLE_HEADER"
    printf "$TABLE_TITLE_FORMAT" "Finished erweak3:"
